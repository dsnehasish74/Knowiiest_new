...
export const fests=[
 ...
 },
 {
...
},
  {
    ...
    src:gyandhara,
    heading:"GYANDHARA",
    body:"This institute has been the guiding light of technical education in this country for the last 150 years.In an attempt to reinvigorate the prestigious quizzing fraternity this college has had, the Quizmaniac BEings (the Quiz Club)) of IIEST Shibpur started off with an unique idea in 2014 of pitching open quizzers one against another in a college.",
    alt:"GYANDHARA"
},
{
id:3,
...
},
{
  id:5,
  src:tedx,
  heading:"TEDX-IIESTSHIBPUR",
  body:"The event will be a perfect blend of ideas and intellectualism.Speakers from various fields of life are invited to share their incentives on various instances and situation and give us ideas to walk upon.A hall full of attendees learn lessons worth a lifetime as they leave.",
...
},
{
  ...
  src:Initium,
  heading:"INITIUM",
  body:"It is the National Mining Technological Festival of the Department of Mining Engineering, IIEST, Shibpur. Started back in 2012 We expect wide scale participation from the industry and academia. There are events like Industrial Problem Solving (IPS) and Paper Presentation by students. Seminar speakers will be from eminent industries.",
  alt:"INITIUM"
},
  {
  id:8,
  src:metallum,
  heading:"METALLUM" ,
  body:"Metallum is the annual symposium cum tech fest presented by Society of Student Metallurgists at IIEST,Shibpur. Amidst the girth of knowledge, the Society of Students Metallurgists (SSM) on behalf of Department of Metallurgyand Materials Engineering at Indian Institute of Engineering Science and Technology, Shibpur formed under the guidanceof acclaimed faculty members intends to promote the enthusiasts to work in the field of research and at industries.",
  alt:"METALLUM"
},
  {
  id:9,
